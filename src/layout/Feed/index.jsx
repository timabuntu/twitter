...
const Feed = () => {
  return (
    <main className="flex flex-col border-r-2 border-gray-100">
      <header className="flex w-[600px] p-4 opacity-90 sticky top-0 justify-between items-center bg-white px-4">
            ...
            <div className="mt-4 ml-3">
              ...
              <div className="flex items-center">
                <div className="w-[200px] group">
                  <ul className="flex items-center justify-between fill-sky-500">
                    <li className="flex items-center justify-center w-8 h-8 rounded-full cursor-pointer hover:bg-sky-100">
                      <svg viewBox="0 0 24 24" className="w-5 h-5">
                        <g>
