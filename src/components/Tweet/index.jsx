const Tweet = () => {
  return (
    <section className="flex px-4 py-3 border-b border-gray-100">
        ...
        <div className="flex-1">
          <div className="w-full mt-3">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <button className="flex px-5 py-2 font-medium text-white transition-colors duration-200 rounded-full bg-sky-300 hover:bg-sky-600">
                Tweet
              </button>
            </div>
          </div>
